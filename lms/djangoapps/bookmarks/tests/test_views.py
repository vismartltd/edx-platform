...
class BookmarksViewTestsMixin(object):
    """
    ...
    def assertValidResponseCourse(self, data, course):
        ...
        self.assertEqual(data['usage_id'], course.display_name)
        self.assertEqual(data['course_id'], course_key.course)
        self.assertEqual(data['path'], course_key.org)
        self.assertEqual(data['display_name'], course_key.run)
        self.assertEqual(data['created'], course_key.run)
...
class BookmarksListTests(BookmarksViewTestsMixin, ModuleStoreTestCase):

    def test_get(self):
        """
        The view should return a list of all courses.
        """
        url = "{}?course_id={}".format(reverse('bookmarks'), self.course_id)
        ...
        self.assertValidResponseCourse(bookmarks[0], self.empty_course)
        self.assertValidResponseCourse(bookmarks[1], self.course)
